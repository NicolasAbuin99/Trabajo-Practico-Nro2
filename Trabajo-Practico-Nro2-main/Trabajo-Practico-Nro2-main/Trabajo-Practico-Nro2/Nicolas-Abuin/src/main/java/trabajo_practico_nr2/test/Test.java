...
public class Test {
    public static void main(String []args){
        ...
        //Odernados por orden natural(Marca, Modelo, Precio)
        System.out.println("Vehículos ordenados por orden natural (marca, modelo, precio):"); 
        List<Vehiculo> ordenNatural = service.ordenarPorOrdenNatural(vehiculos);
        ordenNatural.forEach(System.out::println);
